...
function install(options = {}) {
  ...
  console.log(colors.dim('  - .woorido/ (Agentic Framework Core + Agents)'));
  console.log(colors.dim('  - .claude/skills/woorido/SKILL.md (unified coding rules)'));
  console.log(colors.dim('  - .agent/workflows/*.md (PDCA + QA commands)'));
  console.log(colors.dim('  - hooks/ (Hook System)'));
  console.log(colors.dim('  - scripts/ (Hook Scripts)'));
  console.log();
...
function check() {
  ...
  const checks = [
    ...
    { name: 'hooks/', path: path.join(TARGET_DIR, 'hooks') },
    { name: 'scripts/', path: path.join(TARGET_DIR, 'scripts') },
  ];
